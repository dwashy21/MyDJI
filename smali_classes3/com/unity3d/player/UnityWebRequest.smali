...
.method private static getSSLSocketFactory()Ljavax/net/ssl/SSLSocketFactory;
    ...
    const-string/jumbo v9, "UnityWebRequest: No support for "
    ...
    invoke-static {v7, v1}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V
...
.method public run()V
    ...
    const-string/jumbo v1, "file:// must use an absolute path"
    ...
    const-string/jumbo v1, "A URL Connection to a Java ARchive (JAR) file or an entry in a JAR file is not supported"
