...
.method private a(I)V
    ...
    const-string/jumbo v1, "_adjTransferRate"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "millseconds:"
...
.method private declared-synchronized f()V
    ...
    :try_start_0
    const-string/jumbo v1, "_sendLog"

    const-string/jumbo v2, "_sendlog"
    ...
    const-string/jumbo v2, "skip[No ActiveNetworkInfo]"
    ...
    const-string/jumbo v2, "mIsTransferLogThreadRunning=true"
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 109
    const-string/jumbo v0, "dispatch log error"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "log size is too long, log = "
    ...
    const-string/jumbo v1, "dispatch log"

    const-string/jumbo v2, "direct drop"
    ...
    const-string/jumbo v1, ") is skipped by EventStrategier:"
    ...
    const-string/jumbo v1, "save crash log"
...
.method public b()V
    ...
    const-string/jumbo v2, "in background"
