...
.method public run()V
    ...
    const-string/jumbo v1, "request[transfer_data]"

    const-string/jumbo v3, "skip[no logs]"
    ...
    const-string/jumbo v4, "_sendLog"

    const-string/jumbo v5, "skip[isSyncOnlineConfSuccess=false]"
    ...
    const-string/jumbo v4, "reqeust[transfer_data]"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "mCurPackRecordCount="
    ...
    const-string/jumbo v3, "request[transfer-data]"
