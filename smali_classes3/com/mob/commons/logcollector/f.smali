...
.method public static declared-synchronized a(Landroid/content/Context;JLjava/lang/String;ILjava/lang/String;)J
    ...
    .line 24
    const-string/jumbo v3, "exception_time"
    ...
    .line 25
    const-string/jumbo v3, "exception_msg"
    ...
    .line 26
    const-string/jumbo v3, "exception_level"
...
.method public static declared-synchronized a(Landroid/content/Context;Ljava/util/ArrayList;)J
    ...
    const-string/jumbo v5, "exception_md5 in ( "
    ...
    const-string/jumbo v3, "delete COUNT == %s"
...
.method private static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 90
    const-string/jumbo v1, " select exception_md5, exception_level, exception_time, exception_msg, sum(exception_counts) from table_exception group by exception_md5 having max(_id)"
    ...
    const-string/jumbo v5, " select exception_md5, exception_level, exception_time, exception_msg, sum(exception_counts) from table_exception where "
    ...
    const-string/jumbo v5, " group by exception_md5 having max(_id)"
...
.method public static declared-synchronized a(Landroid/content/Context;[Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_0
    const-string/jumbo v0, "exception_level = ?"
