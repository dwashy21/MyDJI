...
.method protected constructor <init>(Lcom/here/android/mpa/routing/RoutePlan;Lcom/nokia/maps/restrouting/Route;Lcom/nokia/maps/restrouting/SourceAttribution;)V
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->h:Ljava/lang/Double;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->d:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->a:Lcom/here/android/mpa/routing/RoutePlan;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->g:Ljava/util/List;
    ...
    iput v0, p0, Lcom/nokia/maps/fc;->k:I

    .line 64
    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lcom/nokia/maps/fc;->a:Lcom/here/android/mpa/routing/RoutePlan;
    ...
    .line 65
    iget-object v1, p0, Lcom/nokia/maps/fc;->g:Ljava/util/List;

    iget-object v2, p0, Lcom/nokia/maps/fc;->a:Lcom/here/android/mpa/routing/RoutePlan;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->b:Lcom/here/android/mpa/common/GeoBoundingBox;
    ...
    iput v0, p0, Lcom/nokia/maps/fc;->c:I
    ...
    .line 72
    iget-object v4, p0, Lcom/nokia/maps/fc;->d:Ljava/util/List;

    invoke-virtual {v1}, Lcom/nokia/maps/restrouting/Link;->d()Ljava/util/List;

    move-result-object v1

    invoke-static {v1}, Lcom/nokia/maps/el;->b(Ljava/util/List;)Ljava/util/List;
    ...
    .line 76
    :cond_1
    iget-object v1, p0, Lcom/nokia/maps/fc;->h:Ljava/lang/Double;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->i:Ljava/lang/Double;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fc;->j:Ljava/lang/Double;

    .line 81
    invoke-direct {p0, p2}, Lcom/nokia/maps/fc;->a(Lcom/nokia/maps/restrouting/Route;)V
    ...
    invoke-direct {v0, p3}, Lcom/nokia/maps/fd;-><init>(Lcom/nokia/maps/restrouting/SourceAttribution;)V

    .line 84
    invoke-static {v0}, Lcom/nokia/maps/fd;->a(Lcom/nokia/maps/fd;)Lcom/here/android/mpa/routing/TransitRouteSourceAttribution;

    move-result-object v0

    iput-object v0, p0, Lcom/nokia/maps/fc;->l:Lcom/here/android/mpa/routing/TransitRouteSourceAttribution;
...
.method private a(ZI)Lcom/here/android/mpa/routing/RouteTta;
    ...
    iget v0, p0, Lcom/nokia/maps/fc;->k:I
    ...
    :goto_0
    const-string/jumbo v2, "Sub-leg is out-of-range. Use Route.WHOLE_ROUTE to calculate duration for the whole route"
    ...
    iget-object v0, p0, Lcom/nokia/maps/fc;->i:Ljava/lang/Double;
    ...
    .line 506
    :goto_1
    iget-object v0, p0, Lcom/nokia/maps/fc;->e:Ljava/util/List;
    ...
    check-cast v0, Lcom/nokia/maps/ey;
    ...
    .line 511
    invoke-virtual {v0}, Lcom/nokia/maps/ey;->B()Ljava/util/List;

    move-result-object v0

    .line 510
    invoke-static {v0}, Lcom/nokia/maps/el;->a(Ljava/util/List;)Ljava/util/EnumSet;
    ...
    .line 505
    :cond_3
    iget-object v0, p0, Lcom/nokia/maps/fc;->h:Ljava/lang/Double;
    ...
    .line 523
    invoke-virtual {v0}, Lcom/nokia/maps/ey;->z()I
    ...
    .line 540
    :cond_6
    new-instance v0, Lcom/nokia/maps/em;

    invoke-direct {v0, v3, v1}, Lcom/nokia/maps/em;-><init>(Ljava/util/EnumSet;I)V

    invoke-static {v0}, Lcom/nokia/maps/em;->a(Lcom/nokia/maps/RouteTtaImpl;)Lcom/here/android/mpa/routing/RouteTta;
    ...
    invoke-virtual {v0}, Lcom/nokia/maps/ey;->getTransitTravelTime()I
    ...
    .line 530
    :cond_8
    invoke-virtual {v0}, Lcom/nokia/maps/ey;->A()I
...
.method private a(Lcom/nokia/maps/restrouting/Route;)V
    ...
    invoke-static {v2}, Lcom/nokia/maps/el;->h(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/nokia/maps/el;->g(Ljava/lang/String;)Z
    ...
    .line 465
    :cond_6
    new-instance v2, Lcom/nokia/maps/ey;
    ...
    invoke-direct/range {v2 .. v10}, Lcom/nokia/maps/ey;-><init>(ILcom/nokia/maps/restrouting/Maneuver;Lcom/nokia/maps/restrouting/PublicTransportLine;Ljava/util/List;Lcom/nokia/maps/restrouting/Link;IILjava/lang/String;)V

    .line 471
    if-eqz v11, :cond_7

    .line 472
    invoke-virtual {v2}, Lcom/nokia/maps/ey;->e()Lcom/here/android/mpa/routing/RouteOptions$TransportMode;
    ...
    .line 473
    invoke-virtual {v2}, Lcom/nokia/maps/ey;->C()V

    .line 475
    :cond_7
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/nokia/maps/fc;->e:Ljava/util/List;
    ...
    iget-object v2, v0, Lcom/nokia/maps/fc;->e:Ljava/util/List;
    ...
    .line 493
    :cond_c
    new-instance v2, Lcom/nokia/maps/fa;

    invoke-direct {v2, v3}, Lcom/nokia/maps/fa;-><init>(Ljava/util/List;)V
    ...
    iput-object v2, v0, Lcom/nokia/maps/fc;->f:Lcom/here/android/mpa/routing/RouteElements;
...
.method public a(I)Lcom/here/android/mpa/routing/RouteElements;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/nokia/maps/fc;->a(II)Lcom/here/android/mpa/routing/RouteElements;
...
.method public a(II)Lcom/here/android/mpa/routing/RouteElements;
    ...
    .line 310
    :cond_1
    iget-object v0, p0, Lcom/nokia/maps/fc;->j:Ljava/lang/Double;
    ...
    .line 315
    iget-object v0, p0, Lcom/nokia/maps/fc;->f:Lcom/here/android/mpa/routing/RouteElements;
    ...
    check-cast v0, Lcom/nokia/maps/ei;

    .line 319
    invoke-virtual {v0}, Lcom/nokia/maps/ei;->f()Ljava/lang/Double;
    ...
    .line 327
    new-instance v0, Lcom/nokia/maps/fa;

    invoke-direct {v0, v6}, Lcom/nokia/maps/fa;-><init>(Ljava/util/List;)V
...
.method public a(J)Lcom/here/android/mpa/routing/RouteElements;
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Lcom/nokia/maps/fc;->a(JJ)Lcom/here/android/mpa/routing/RouteElements;
...
.method public a(JJ)Lcom/here/android/mpa/routing/RouteElements;
    ...
    .line 275
    invoke-virtual {v0}, Lcom/nokia/maps/ei;->g()Ljava/lang/Double;
    ...
    invoke-direct {v0, v1}, Lcom/nokia/maps/fa;-><init>(Ljava/util/List;)V
...
.method public a(Lcom/here/android/mpa/routing/Maneuver;)Lcom/here/android/mpa/routing/RouteElements;
    ...
    invoke-direct {v0, p1}, Lcom/nokia/maps/fa;-><init>(Lcom/here/android/mpa/routing/Maneuver;)V
...
.method public a(Lcom/here/android/mpa/routing/Route$TrafficPenaltyMode;I)Lcom/here/android/mpa/routing/RouteTta;
    ...
    :goto_0
    invoke-direct {p0, v0, p2}, Lcom/nokia/maps/fc;->a(ZI)Lcom/here/android/mpa/routing/RouteTta;
...
.method public a(Lcom/here/android/mpa/common/RoadElement;II)Lcom/here/android/mpa/routing/a;
    ...
    const-string/jumbo v1, "getFirstIntersectionAfter operation is not supported for timetabled transit route."
...
.method public a(Z)Ljava/util/List;
    ...
    .prologue
    .line 130
    iget-object v0, p0, Lcom/nokia/maps/fc;->d:Ljava/util/List;
...
.method public b()Lcom/here/android/mpa/common/GeoBoundingBox;
    ...
    .prologue
    .line 96
    iget-object v0, p0, Lcom/nokia/maps/fc;->b:Lcom/here/android/mpa/common/GeoBoundingBox;
...
.method public b(Lcom/here/android/mpa/common/RoadElement;II)Ljava/util/List;
    ...
    const-string/jumbo v1, "getAllIntersectionsAfter operation is not supported for timetabled transit route."
...
.method public c()Lcom/here/android/mpa/routing/RoutePlan;
    ...
    .prologue
    .line 180
    iget-object v0, p0, Lcom/nokia/maps/fc;->a:Lcom/here/android/mpa/routing/RoutePlan;
...
.method public e()Lcom/here/android/mpa/routing/Maneuver;
    ...
    .line 141
    iget-object v1, p0, Lcom/nokia/maps/fc;->e:Ljava/util/List;
...
.method public f()Ljava/util/List;
    ...
    .prologue
    .line 154
    iget-object v0, p0, Lcom/nokia/maps/fc;->g:Ljava/util/List;
...
.method public g()Ljava/util/List;
    ...
    .line 167
    iget-object v3, p0, Lcom/nokia/maps/fc;->a:Lcom/here/android/mpa/routing/RoutePlan;
...
.method public getLength()I
    ...
    .prologue
    .line 106
    iget v0, p0, Lcom/nokia/maps/fc;->c:I
...
.method public l()Lcom/here/android/mpa/routing/TransitRouteSourceAttribution;
    ...
    .prologue
    .line 545
    iget-object v0, p0, Lcom/nokia/maps/fc;->l:Lcom/here/android/mpa/routing/TransitRouteSourceAttribution;
