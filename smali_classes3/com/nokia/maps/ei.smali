...
.method constructor <init>(Lcom/here/android/mpa/common/RoadElement;)V
    ...
    iput-object v0, p0, Lcom/nokia/maps/ei;->c:Lcom/here/android/mpa/routing/RouteElement$Type;

    .line 33
    iput-object p1, p0, Lcom/nokia/maps/ei;->d:Lcom/here/android/mpa/common/RoadElement;
    ...
    .line 38
    invoke-virtual {v0}, Lcom/nokia/maps/eh;->d()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lcom/nokia/maps/ei;->f:Ljava/util/List;

    .line 39
    invoke-virtual {v0}, Lcom/nokia/maps/eh;->f()Ljava/lang/Double;

    move-result-object v1

    iput-object v1, p0, Lcom/nokia/maps/ei;->a:Ljava/lang/Double;

    .line 40
    invoke-virtual {v0}, Lcom/nokia/maps/eh;->g()Ljava/lang/Double;

    move-result-object v0

    iput-object v0, p0, Lcom/nokia/maps/ei;->b:Ljava/lang/Double;
    ...
    iput-object v0, p0, Lcom/nokia/maps/ei;->f:Ljava/util/List;
...
.method constructor <init>(Lcom/here/android/mpa/routing/TransitRouteElement;)V
    ...
    .line 50
    iput-object p1, p0, Lcom/nokia/maps/ei;->e:Lcom/here/android/mpa/routing/TransitRouteElement;
    ...
    check-cast v0, Lcom/nokia/maps/ez;

    .line 55
    if-eqz v0, :cond_1

    .line 56
    invoke-virtual {v0}, Lcom/nokia/maps/ez;->n()Ljava/lang/Double;
    ...
    .line 57
    invoke-virtual {v0}, Lcom/nokia/maps/ez;->o()Ljava/lang/Double;
...
.method public b()Lcom/here/android/mpa/routing/RouteElement$Type;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lcom/nokia/maps/ei;->c:Lcom/here/android/mpa/routing/RouteElement$Type;
...
.method public c()Lcom/here/android/mpa/common/RoadElement;
    ...
    .prologue
    .line 82
    iget-object v0, p0, Lcom/nokia/maps/ei;->d:Lcom/here/android/mpa/common/RoadElement;
...
.method public d()Lcom/here/android/mpa/routing/TransitRouteElement;
    ...
    .prologue
    .line 93
    iget-object v0, p0, Lcom/nokia/maps/ei;->e:Lcom/here/android/mpa/routing/TransitRouteElement;
...
.method public e()Ljava/util/List;
    ...
    .prologue
    .line 104
    iget-object v0, p0, Lcom/nokia/maps/ei;->f:Ljava/util/List;
...
.method f()Ljava/lang/Double;
    ...
    .prologue
    .line 113
    iget-object v0, p0, Lcom/nokia/maps/ei;->a:Ljava/lang/Double;
...
.method g()Ljava/lang/Double;
    ...
    .prologue
    .line 117
    iget-object v0, p0, Lcom/nokia/maps/ei;->b:Ljava/lang/Double;
...
.method public isValid()Z
    ...
    .line 109
    iget-object v2, p0, Lcom/nokia/maps/ei;->c:Lcom/here/android/mpa/routing/RouteElement$Type;

    sget-object v3, Lcom/here/android/mpa/routing/RouteElement$Type;->ROAD:Lcom/here/android/mpa/routing/RouteElement$Type;

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Lcom/nokia/maps/ei;->d:Lcom/here/android/mpa/common/RoadElement;
    ...
    :cond_2
    iget-object v2, p0, Lcom/nokia/maps/ei;->e:Lcom/here/android/mpa/routing/TransitRouteElement;
