.class final Lcom/nokia/maps/fb;
.super Lcom/nokia/maps/ek;
...
.method constructor <init>(Lcom/here/android/mpa/routing/RouteManager;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1}, Lcom/nokia/maps/ek;-><init>(Lcom/here/android/mpa/routing/RouteManager;)V

    .line 65
    new-instance v0, Lcom/nokia/maps/TransitRouteRestHandler$1;

    invoke-direct {v0, p0}, Lcom/nokia/maps/TransitRouteRestHandler$1;-><init>(Lcom/nokia/maps/fb;)V

    iput-object v0, p0, Lcom/nokia/maps/fb;->d:Lcom/nokia/maps/ApplicationContext$c;

    .line 38
    return-void
.end method

.method static synthetic a(Lcom/nokia/maps/fb;)Lcom/here/android/mpa/routing/RoutePlan;
    .locals 1

    .prologue
    .line 30
    iget-object v0, p0, Lcom/nokia/maps/fb;->a:Lcom/here/android/mpa/routing/RoutePlan;
...
.method private declared-synchronized b()Lcom/here/android/mpa/routing/RouteManager$Error;
    ...
    :goto_0
    :try_start_2
    invoke-virtual {p0}, Lcom/nokia/maps/fb;->a()Lcom/here/android/mpa/routing/RouteManager;

    move-result-object v2

    invoke-static {v2}, Lcom/nokia/maps/RouteManagerImpl;->a(Lcom/here/android/mpa/routing/RouteManager;)Lcom/nokia/maps/RouteManagerImpl;

    move-result-object v2

    invoke-virtual {v2}, Lcom/nokia/maps/RouteManagerImpl;->e()Lcom/here/android/mpa/routing/CoreRouter$Connectivity;
    ...
    iget-object v3, p0, Lcom/nokia/maps/fb;->d:Lcom/nokia/maps/ApplicationContext$c;
    ...
    iget-object v1, p0, Lcom/nokia/maps/fb;->a:Lcom/here/android/mpa/routing/RoutePlan;

    iget-object v2, p0, Lcom/nokia/maps/fb;->b:Lcom/here/android/mpa/routing/RouteManager$Listener;
...
.method static synthetic b(Lcom/nokia/maps/fb;)Lcom/here/android/mpa/routing/RouteManager$Listener;
    .locals 1

    .prologue
    .line 30
    iget-object v0, p0, Lcom/nokia/maps/fb;->b:Lcom/here/android/mpa/routing/RouteManager$Listener;
...
.method private c()V
    ...
    .line 92
    const-string/jumbo v1, "lineattributes"
    ...
    .line 93
    const-string/jumbo v1, "combineChange"
    ...
    .line 96
    iget-object v2, p0, Lcom/nokia/maps/fb;->a:Lcom/here/android/mpa/routing/RoutePlan;
    ...
    .line 98
    invoke-static {v1}, Lcom/nokia/maps/el;->a(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v2, v0}, Lcom/nokia/maps/fb;->a(Ljava/lang/String;Lcom/here/android/mpa/routing/RoutePlan;Ljava/util/Map;)Ljava/lang/String;

    move-result-object v0

    .line 103
    invoke-virtual {p0, v0}, Lcom/nokia/maps/fb;->a(Ljava/lang/String;)V

    .line 104
    return-void
.end method

.method static synthetic c(Lcom/nokia/maps/fb;)V
    .locals 0

    .prologue
    .line 30
    invoke-direct {p0}, Lcom/nokia/maps/fb;->c()V
...
.method public a(Lcom/here/android/mpa/routing/RoutePlan;Lcom/here/android/mpa/routing/RouteManager$Listener;)Lcom/here/android/mpa/routing/RouteManager$Error;
    ...
    iput-object v0, p0, Lcom/nokia/maps/fb;->a:Lcom/here/android/mpa/routing/RoutePlan;

    .line 43
    iput-object p2, p0, Lcom/nokia/maps/fb;->b:Lcom/here/android/mpa/routing/RouteManager$Listener;

    .line 44
    invoke-direct {p0}, Lcom/nokia/maps/fb;->b()Lcom/here/android/mpa/routing/RouteManager$Error;
...
.method protected synthetic a([B)Ljava/lang/Object;
    ...
    .prologue
    .line 30
    invoke-virtual {p0, p1}, Lcom/nokia/maps/fb;->b([B)Ljava/lang/String;
...
.method protected synthetic a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/nokia/maps/fb;->b(Ljava/lang/String;)V
...
.method protected b(Ljava/lang/String;)V
    ...
    .line 117
    iput-object p1, p0, Lcom/nokia/maps/fb;->c:Ljava/lang/String;

    .line 119
    iget-object v0, p0, Lcom/nokia/maps/fb;->c:Ljava/lang/String;

    if-eqz v0, :cond_a

    .line 120
    invoke-static {}, Lcom/nokia/maps/en;->a()Lcom/nokia/maps/en;

    move-result-object v0

    iget-object v3, p0, Lcom/nokia/maps/fb;->c:Ljava/lang/String;

    const-class v5, Lcom/nokia/maps/restrouting/RoutingRestResult;

    invoke-virtual {v0, v3, v5}, Lcom/nokia/maps/en;->a(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 126
    new-instance v6, Lcom/nokia/maps/eo;

    invoke-direct {v6}, Lcom/nokia/maps/eo;-><init>()V

    .line 129
    new-instance v7, Lcom/nokia/maps/fc;

    iget-object v8, p0, Lcom/nokia/maps/fb;->a:Lcom/here/android/mpa/routing/RoutePlan;
    ...
    invoke-direct {v7, v8, v1, v9}, Lcom/nokia/maps/fc;-><init>(Lcom/here/android/mpa/routing/RoutePlan;Lcom/nokia/maps/restrouting/Route;Lcom/nokia/maps/restrouting/SourceAttribution;)V

    .line 129
    invoke-virtual {v6, v7}, Lcom/nokia/maps/eo;->a(Lcom/nokia/maps/RouteImpl;)V
    ...
    sget-object v10, Lcom/nokia/maps/ek$d;->d:Lcom/nokia/maps/ek$d;

    invoke-virtual {v10}, Lcom/nokia/maps/ek$d;->a()Ljava/lang/String;
    ...
    .line 142
    sget-object v9, Lcom/nokia/maps/ek$b;->a:Lcom/nokia/maps/ek$b;

    invoke-virtual {v9}, Lcom/nokia/maps/ek$b;->a()Ljava/lang/String;
    ...
    .line 145
    :cond_1
    sget-object v9, Lcom/nokia/maps/ek$b;->b:Lcom/nokia/maps/ek$b;
    ...
    .line 148
    :cond_2
    sget-object v9, Lcom/nokia/maps/ek$b;->c:Lcom/nokia/maps/ek$b;
    ...
    .line 151
    :cond_3
    sget-object v9, Lcom/nokia/maps/ek$b;->d:Lcom/nokia/maps/ek$b;
    ...
    .line 154
    :cond_4
    sget-object v9, Lcom/nokia/maps/ek$b;->f:Lcom/nokia/maps/ek$b;
    ...
    .line 157
    :cond_5
    sget-object v9, Lcom/nokia/maps/ek$b;->g:Lcom/nokia/maps/ek$b;
    ...
    .line 160
    :cond_6
    sget-object v9, Lcom/nokia/maps/ek$b;->h:Lcom/nokia/maps/ek$b;
    ...
    .line 163
    :cond_7
    sget-object v9, Lcom/nokia/maps/ek$b;->i:Lcom/nokia/maps/ek$b;
    ...
    .line 170
    :cond_8
    invoke-virtual {v6, v7}, Lcom/nokia/maps/eo;->a(Ljava/util/EnumSet;)V
    ...
    .line 178
    invoke-static {v0}, Lcom/nokia/maps/eo;->a(Lcom/nokia/maps/eo;)Lcom/here/android/mpa/routing/RouteResult;
    ...
    .line 184
    new-instance v0, Lcom/nokia/maps/fb$1;

    invoke-direct {v0, p0, v1, v3}, Lcom/nokia/maps/fb$1;-><init>(Lcom/nokia/maps/fb;Lcom/here/android/mpa/routing/RouteManager$Error;Ljava/util/List;)V
