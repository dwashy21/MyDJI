...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ldji/gs/c/f;Landroid/view/View;)V
    .locals 6
    ...
    .line 49
    iput-object p1, p0, Ldji/gs/views/c;->h:Landroid/content/Context;

    .line 50
    iput-object p3, p0, Ldji/gs/views/c;->i:Landroid/view/View;
    ...
    .line 53
    invoke-virtual {p0, v4, v4}, Ldji/gs/views/c;->setWindowLayoutMode(II)V
    ...
    .line 56
    invoke-virtual {p0, v5}, Ldji/gs/views/c;->setFocusable(Z)V

    .line 57
    invoke-virtual {p0, v5}, Ldji/gs/views/c;->setOutsideTouchable(Z)V
    ...
    iput-object v0, p0, Ldji/gs/views/c;->c:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ldji/gs/views/c;->g:Landroid/widget/TextView;

    .line 62
    iput-object p2, p0, Ldji/gs/views/c;->d:Ldji/gs/c/f;
...
.method private a()V
    ...
    .prologue
    .line 82
    iget-object v0, p0, Ldji/gs/views/c;->d:Ldji/gs/c/f;

    invoke-interface {v0}, Ldji/gs/c/f;->f()I

    move-result v0

    iput v0, p0, Ldji/gs/views/c;->e:I

    .line 83
    iget-object v0, p0, Ldji/gs/views/c;->d:Ldji/gs/c/f;

    iget v1, p0, Ldji/gs/views/c;->e:I
    ...
    iput-object v0, p0, Ldji/gs/views/c;->f:Ldji/gs/e/e;

    .line 84
    iget-object v0, p0, Ldji/gs/views/c;->g:Landroid/widget/TextView;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v2, p0, Ldji/gs/views/c;->h:Landroid/content/Context;

    sget v3, Ldji/gs/R$string;->gs_manager_point_info:I

    invoke-static {v2, v3}, Ldji/gs/utils/e;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    iget v2, p0, Ldji/gs/views/c;->e:I
    ...
    iget-object v1, p0, Ldji/gs/views/c;->f:Ldji/gs/e/e;
...
.method public a(II)V
    ...
    .line 67
    iget-object v0, p0, Ldji/gs/views/c;->i:Landroid/view/View;
...
.method public dismiss()V
    ...
    invoke-interface {v0}, Ldji/gs/c/f;->t()V
