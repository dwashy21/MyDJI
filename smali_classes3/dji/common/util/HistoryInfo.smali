...
.field private dischargeFlag:Z

.field private firstLevelCurrent:Z

.field private firstLevelLowTemp:Z

.field private firstLevelOverTemp:Z

.field private invalidNum:B

.field private originalError:I

.field private originalNewError:J

.field private replaceFlag:B

.field private secondLevelCurrent:Z

.field private secondLevelLowTemp:Z

.field private secondLevelOverTemp:Z

.field private shortCircuit:Z

.field private underVoltageNum:B

.field private watchDogReset:Z
...
.method public constructor <init>()V
    ...
    .line 41
    iput v2, p0, Ldji/common/util/HistoryInfo;->originalError:I

    .line 42
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ldji/common/util/HistoryInfo;->originalNewError:J
    ...
    iput-object v0, p0, Ldji/common/util/HistoryInfo;->connStatus:Ldji/midware/data/model/P3/DataCenterGetPushBatteryCommon$ConnStatus;

    .line 45
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->firstLevelCurrent:Z

    .line 46
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->secondLevelCurrent:Z

    .line 47
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->firstLevelOverTemp:Z

    .line 48
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->secondLevelOverTemp:Z

    .line 49
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->firstLevelLowTemp:Z

    .line 50
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->secondLevelLowTemp:Z

    .line 51
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->shortCircuit:Z

    .line 52
    iput-byte v2, p0, Ldji/common/util/HistoryInfo;->underVoltageNum:B

    .line 53
    iput-byte v2, p0, Ldji/common/util/HistoryInfo;->invalidNum:B

    .line 54
    iput-byte v2, p0, Ldji/common/util/HistoryInfo;->replaceFlag:B

    .line 55
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->watchDogReset:Z

    .line 56
    iput-boolean v2, p0, Ldji/common/util/HistoryInfo;->dischargeFlag:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 312
    iget v1, p0, Ldji/common/util/HistoryInfo;->originalError:I

    iget v2, p1, Ldji/common/util/HistoryInfo;->originalError:I
...
.method public getConnStatus()Ldji/midware/data/model/P3/DataCenterGetPushBatteryCommon$ConnStatus;
    ...
    .prologue
    .line 91
    iget-object v0, p0, Ldji/common/util/HistoryInfo;->connStatus:Ldji/midware/data/model/P3/DataCenterGetPushBatteryCommon$ConnStatus;
...
.method public getInvalidNum()B
    ...
    .prologue
    .line 190
    iget-byte v0, p0, Ldji/common/util/HistoryInfo;->invalidNum:B
...
.method public getReplaceFlag()B
    ...
    .prologue
    .line 201
    iget-byte v0, p0, Ldji/common/util/HistoryInfo;->replaceFlag:B
...
.method public getUnderVoltageNum()B
    ...
    .prologue
    .line 179
    iget-byte v0, p0, Ldji/common/util/HistoryInfo;->underVoltageNum:B
...
.method public hasDischargeSelf()Z
    ...
    .prologue
    .line 223
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->dischargeFlag:Z
...
.method public hasFirstLevelCurrent()Z
    ...
    .prologue
    .line 102
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelCurrent:Z
...
.method public hasFirstLevelLowTemp()Z
    ...
    .prologue
    .line 146
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelLowTemp:Z
...
.method public hasFirstLevelOverTemp()Z
    ...
    .prologue
    .line 124
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelOverTemp:Z
...
.method public hasSecondLevelCurrent()Z
    ...
    .prologue
    .line 113
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelCurrent:Z
...
.method public hasSecondLevelLowTemp()Z
    ...
    .prologue
    .line 157
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelLowTemp:Z
...
.method public hasSecondLevelOverTemp()Z
    ...
    .prologue
    .line 135
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelOverTemp:Z
...
.method public hasShortCircuit()Z
    ...
    .prologue
    .line 168
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->shortCircuit:Z
...
.method public hasWatchDogReset()Z
    ...
    .prologue
    .line 212
    iget-boolean v0, p0, Ldji/common/util/HistoryInfo;->watchDogReset:Z
...
.method public hashCode()I
    ...
    .prologue
    .line 321
    iget v0, p0, Ldji/common/util/HistoryInfo;->originalError:I
...
.method public parse(I)V
    ...
    .line 249
    iput p1, p0, Ldji/common/util/HistoryInfo;->originalError:I
    ...
    :goto_0
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelCurrent:Z
    ...
    :goto_1
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelCurrent:Z
    ...
    :goto_2
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelOverTemp:Z
    ...
    :goto_3
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelOverTemp:Z
    ...
    :goto_4
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->firstLevelLowTemp:Z
    ...
    :goto_5
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->secondLevelLowTemp:Z
    ...
    :goto_6
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->shortCircuit:Z
    ...
    iput-byte v0, p0, Ldji/common/util/HistoryInfo;->underVoltageNum:B
    ...
    iput-byte v0, p0, Ldji/common/util/HistoryInfo;->invalidNum:B
    ...
    iput-byte v0, p0, Ldji/common/util/HistoryInfo;->replaceFlag:B
    ...
    :goto_7
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->watchDogReset:Z
    ...
    :goto_8
    iput-boolean v1, p0, Ldji/common/util/HistoryInfo;->dischargeFlag:Z
...
.method public parse(J)V
    ...
    .line 337
    iput-wide p1, p0, Ldji/common/util/HistoryInfo;->originalNewError:J
...
.method public reset()V
    ...
    .line 293
    iput-boolean v0, p0, Ldji/common/util/HistoryInfo;->dischargeFlag:Z
...
.method public updateConnStatus(Ldji/midware/data/model/P3/DataCenterGetPushBatteryCommon$ConnStatus;)V
    ...
    .prologue
    .line 272
    iput-object p1, p0, Ldji/common/util/HistoryInfo;->connStatus:Ldji/midware/data/model/P3/DataCenterGetPushBatteryCommon$ConnStatus;
