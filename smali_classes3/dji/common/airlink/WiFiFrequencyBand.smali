...
.field public static final enum FREQUENCY_BAND_2_DOT_4_GHZ:Ldji/common/airlink/WiFiFrequencyBand;

.field public static final enum FREQUENCY_BAND_5_GHZ:Ldji/common/airlink/WiFiFrequencyBand;

.field public static final enum FREQUENCY_BAND_DUAL:Ldji/common/airlink/WiFiFrequencyBand;

.field public static final enum FrequencyBandOnly2Dot4:Ldji/common/airlink/WiFiFrequencyBand;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "FrequencyBandOnly2Dot4"

    const/4 v2, -0x1

    invoke-direct {v0, v1, v3, v2}, Ldji/common/airlink/WiFiFrequencyBand;-><init>(Ljava/lang/String;II)V

    sput-object v0, Ldji/common/airlink/WiFiFrequencyBand;->FrequencyBandOnly2Dot4:Ldji/common/airlink/WiFiFrequencyBand;
    ...
    invoke-direct {v0, v1, v4, v3}, Ldji/common/airlink/WiFiFrequencyBand;-><init>(Ljava/lang/String;II)V

    sput-object v0, Ldji/common/airlink/WiFiFrequencyBand;->FREQUENCY_BAND_2_DOT_4_GHZ:Ldji/common/airlink/WiFiFrequencyBand;

    .line 23
    new-instance v0, Ldji/common/airlink/WiFiFrequencyBand;

    const-string/jumbo v1, "FREQUENCY_BAND_5_GHZ"

    invoke-direct {v0, v1, v5, v4}, Ldji/common/airlink/WiFiFrequencyBand;-><init>(Ljava/lang/String;II)V

    sput-object v0, Ldji/common/airlink/WiFiFrequencyBand;->FREQUENCY_BAND_5_GHZ:Ldji/common/airlink/WiFiFrequencyBand;

    .line 30
    new-instance v0, Ldji/common/airlink/WiFiFrequencyBand;

    const-string/jumbo v1, "FREQUENCY_BAND_DUAL"

    invoke-direct {v0, v1, v6, v5}, Ldji/common/airlink/WiFiFrequencyBand;-><init>(Ljava/lang/String;II)V

    sput-object v0, Ldji/common/airlink/WiFiFrequencyBand;->FREQUENCY_BAND_DUAL:Ldji/common/airlink/WiFiFrequencyBand;
    ...
    invoke-direct {v0, v1, v7, v2}, Ldji/common/airlink/WiFiFrequencyBand;-><init>(Ljava/lang/String;II)V
...
.method public static find(I)Ldji/common/airlink/WiFiFrequencyBand;
    ...
    invoke-direct {v2, p0}, Ldji/common/airlink/WiFiFrequencyBand;->_equals(I)Z
