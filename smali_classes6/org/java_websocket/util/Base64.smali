...
.method public static decode(Ljava/lang/String;I)[B
    ...
    invoke-static {v0, v4, v1, p1}, Lorg/java_websocket/util/Base64;->decode([BIII)[B
...
.method public static decode([BIII)[B
    ...
    .line 1189
    invoke-static {v7, v1, v6, v3, p3}, Lorg/java_websocket/util/Base64;->decode4to3([BI[BII)I
...
.method public static decodeFromFile(Ljava/lang/String;)[B
    ...
    invoke-direct {v2, v5, v3}, Lorg/java_websocket/util/Base64$InputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_3
    ...
    :try_start_4
    invoke-virtual {v2, v4, v0, v1}, Lorg/java_websocket/util/Base64$InputStream;->read([BII)I
...
.method public static decodeToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0, v3}, Lorg/java_websocket/util/Base64$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    invoke-virtual {v1, v0}, Lorg/java_websocket/util/Base64$OutputStream;->write([B)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_3
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static decodeToObject(Ljava/lang/String;ILjava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_4
    new-instance v0, Lorg/java_websocket/util/Base64$1;

    invoke-direct {v0, v2, p2}, Lorg/java_websocket/util/Base64$1;-><init>(Ljava/io/InputStream;Ljava/lang/ClassLoader;)V
    :try_end_4
...
.method public static encode(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    .line 564
    invoke-static {v1, v0, v2, v3}, Lorg/java_websocket/util/Base64;->encode3to4([B[BII)[B
...
.method public static encode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)V
    ...
    .line 588
    invoke-static {v3, v2, v0, v1}, Lorg/java_websocket/util/Base64;->encode3to4([B[BII)[B
...
.method public static encodeBytes([BII)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, p1, p2, v1}, Lorg/java_websocket/util/Base64;->encodeBytes([BIII)Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static encodeBytesToBytes([B)[B
    ...
    invoke-static {p0, v1, v2, v3}, Lorg/java_websocket/util/Base64;->encodeBytesToBytes([BIII)[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static encodeFromFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v5, v3}, Lorg/java_websocket/util/Base64$InputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    :try_start_1
    invoke-virtual {v1, v4, v0, v2}, Lorg/java_websocket/util/Base64$InputStream;->read([BII)I
...
.method public static encodeObject(Ljava/io/Serializable;I)Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v0}, Lorg/java_websocket/util/Base64$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
