...
.method private pickForcedLocalAddress()[I
    ...
    .line 3759
    const-string/jumbo v2, "ftp4j.activeDataTransfer.hostAddress"
    ...
    const-string/jumbo v3, "WARNING: invalid value \""
    ...
    const-string/jumbo v3, "\" for the "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v2

    const-string/jumbo v3, "ftp4j.activeDataTransfer.hostAddress"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v2

    const-string/jumbo v3, " system property. The value should "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v2

    const-string/jumbo v3, "be in the x.x.x.x form."
...
.method private postLoginOperations()V
    ...
    .line 1342
    const-string/jumbo v5, "REST STREAM"
    ...
    const-string/jumbo v3, "OPTS UTF8 ON"
...
.method public append(Ljava/lang/String;Ljava/io/InputStream;JLit/sauronsoftware/ftp4j/FTPDataTransferListener;)V
    ...
    const-string/jumbo v1, "Client not connected"
    ...
    const-string/jumbo v1, "Client not authenticated"
    ...
    const-string/jumbo v6, "I/O error in data transfer"
...
.method public changeAccount(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Client not connected"
    ...
    const-string/jumbo v2, "Client not authenticated"
...
.method public connect(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    const-string/jumbo v3, "Client already connected to "
...
.method public listNames()[Ljava/lang/String;
    ...
    const-string/jumbo v7, "I/O error in data transfer"
...
.method public login(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "AUTH SSL"
    ...
    const-string/jumbo v2, "SECURITY_FTPES cannot be applied: the server refused both AUTH TLS and AUTH SSL commands"
...
.method public setMLSDPolicy(I)V
    ...
    const-string/jumbo v1, "Invalid MLSD policy"
...
.method public setSecurity(I)V
    ...
    const-string/jumbo v1, "Invalid security"
    ...
    const-string/jumbo v2, "The security level of the connection can\'t be changed while the client is connected"
...
.method public toString()Ljava/lang/String;
    ...
    .line 3839
    :goto_0
    const-string/jumbo v1, ", authenticated="
    ...
    .line 3830
    :pswitch_0
    const-string/jumbo v1, "SECURITY_FTP"
    ...
    :pswitch_1
    :try_start_1
    const-string/jumbo v1, "SECURITY_FTPS"
    ...
    .line 3836
    :pswitch_2
    const-string/jumbo v1, "SECURITY_FTPES"
    ...
    .line 3850
    const-string/jumbo v1, ", restSupported="
    ...
    .line 3852
    const-string/jumbo v1, ", utf8supported="
    ...
    .line 3854
    const-string/jumbo v1, ", mlsdSupported="
    ...
    .line 3856
    const-string/jumbo v1, ", mode=modezSupported"
    ...
    .line 3858
    const-string/jumbo v1, ", mode=modezEnabled"
    ...
    .line 3861
    :cond_2
    const-string/jumbo v1, ", transfer mode="
    ...
    .line 3863
    const-string/jumbo v1, ", transfer type="
    ...
    .line 3875
    :goto_3
    const-string/jumbo v1, ", textualExtensionRecognizer="
    ...
    .line 3879
    const-string/jumbo v1, ", listParsers="
    ...
    .line 3866
    :pswitch_3
    const-string/jumbo v1, "TYPE_AUTO"
    ...
    .line 3869
    :pswitch_4
    const-string/jumbo v1, "TYPE_BINARY"
    ...
    .line 3872
    :pswitch_5
    const-string/jumbo v1, "TYPE_TEXTUAL"
    ...
    .line 3889
    const-string/jumbo v4, ", communicationListeners="
    ...
    .line 3897
    :cond_7
    const-string/jumbo v0, ", autoNoopTimeout="
...
.method public upload(Ljava/lang/String;Ljava/io/InputStream;JJLit/sauronsoftware/ftp4j/FTPDataTransferListener;)V
    ...
    const-string/jumbo v3, "Client not connected"
    ...
    const-string/jumbo v3, "Client not authenticated"
    ...
    const-string/jumbo v8, "I/O error in data transfer"
