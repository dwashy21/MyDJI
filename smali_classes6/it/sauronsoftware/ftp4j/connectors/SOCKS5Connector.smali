...
.method private read(Ljava/io/InputStream;)I
    ...
    const-string/jumbo v1, "SOCKS5Connector: connection closed by the proxy"
...
.method private socksConnect(Ljava/lang/String;IZ)Ljava/net/Socket;
    ...
    const-string/jumbo v1, "SOCKS5Connector: invalid proxy response"
    ...
    const-string/jumbo v1, "SOCKS5Connector: proxy doesn\'t support username/password authentication method"
    ...
    const-string/jumbo v1, "SOCKS5Connector: username too long"
    ...
    const-string/jumbo v1, "SOCKS5Connector: password too long"
    ...
    const-string/jumbo v1, "SOCKS5Connector: authentication failed"
    ...
    const-string/jumbo v1, "SOCKS5Connector: proxy requires authentication"
    ...
    const-string/jumbo v1, "SOCKS5Connector: domain name too long"
    ...
    const-string/jumbo v1, "SOCKS5Connector: general failure"
    ...
    const-string/jumbo v1, "SOCKS5Connector: connection not allowed by ruleset"
    ...
    const-string/jumbo v1, "SOCKS5Connector: network unreachable"
    ...
    const-string/jumbo v1, "SOCKS5Connector: host unreachable"
    ...
    const-string/jumbo v1, "SOCKS5Connector: connection refused by destination host"
    ...
    const-string/jumbo v1, "SOCKS5Connector: TTL expired"
    ...
    const-string/jumbo v1, "SOCKS5Connector: command not supported / protocol error"
    ...
    const-string/jumbo v1, "SOCKS5Connector: address type not supported"
