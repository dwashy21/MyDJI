...
.method public constructor <init>(Lcom/alibaba/sdk/android/callback/InitResultCallback;Ljava/lang/Integer;)V
    ...
    const-string/jumbo v3, "init_sdk"

    const-string/jumbo v4, "initTask"
    ...
    const-string/jumbo v4, "disableMultiProcessPluginSupport"
...
.method private static a(Ljava/lang/String;)V
    ...
    .line 337
    :try_start_0
    const-string/jumbo v0, "com.alibaba.sdk.android.hotpatch.HotPatchManager"
    ...
    .line 339
    const-string/jumbo v1, "com.alibaba.sdk.android.hotpatch.HotPatchManager"
...
.method static synthetic a(ZJLjava/lang/String;)V
    ...
    const-string/jumbo v4, "initSuccess"
    ...
    const-string/jumbo v1, "sdk_init_result"
    ...
    :cond_2
    const-string/jumbo v4, "initFailed"
...
.method private c()Z
    ...
    .line 185
    const-string/jumbo v0, "securityGuardInit"
    ...
    const-string/jumbo v3, "com.alibaba.sdk.android.security.SecurityGuardService"

    const-string/jumbo v4, "com.alibaba.sdk.android.security.impl.SecurityGuardWrapper"
    ...
    .line 197
    :cond_2
    const-string/jumbo v0, "com.alibaba.app.appkey"
    ...
    const-string/jumbo v3, "com.alibaba.app.appkey"
    ...
    .line 203
    :cond_3
    const-string/jumbo v0, "com.alibaba.app.appsecret"
    ...
    const-string/jumbo v3, "com.alibaba.app.appsecret"
    ...
    const-string/jumbo v3, "com.alibaba.sdk.android.hotpatch.HotPatchManager"

    const-string/jumbo v4, "com.alibaba.sdk.android.hotpatch.impl.HotPatchManagerImpl"
    ...
    const-string/jumbo v4, "com.alibaba.sdk.android.ut.impl.AlibabaUserTrackerService"

    const-string/jumbo v5, "$isv_scope$"
    ...
    .line 249
    const-string/jumbo v3, "traceHelperInit"
    ...
    const-string/jumbo v4, "kernel"

    const-string/jumbo v5, "traceHelperInit"
    ...
    const-string/jumbo v3, "Fail to initialize the UT user tracker service, will fallback to the default one"
    ...
    .line 265
    :cond_a
    const-string/jumbo v4, "plugin.vendor"
    ...
    .line 293
    const-string/jumbo v3, "syncRun"

    const-string/jumbo v4, "kernel"

    const-string/jumbo v5, "syncRun"
...
.method public final run()V
    ...
    const-string/jumbo v1, "asyncRun"
    ...
    const-string/jumbo v0, "asyncRun"

    const-string/jumbo v1, "kernel"

    const-string/jumbo v2, "asyncRun"
