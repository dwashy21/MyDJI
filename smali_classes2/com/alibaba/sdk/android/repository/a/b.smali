...
.method private static a(Ljava/lang/String;Ljava/util/Properties;)Lcom/alibaba/sdk/android/plugin/PluginInfo;
    ...
    .prologue
    .line 92
    const-string/jumbo v0, "plugin.name"
    ...
    const-string/jumbo v2, "Unable to find expected plugin property plugin.name in the file "
    ...
    const-string/jumbo v8, "Invalid property configuration "
    ...
    const-string/jumbo v7, " in the file "
    ...
    const-string/jumbo v1, ".lifecycleAdapter.class"
    ...
    const-string/jumbo v5, "No plugin lifecycle adapter is defined for the plugin "
    ...
    const-string/jumbo v5, " in the file "
    ...
    const-string/jumbo v1, ".beforeAll"
    ...
    const-string/jumbo v1, ".afterAll"
    ...
    const-string/jumbo v2, " config the beforeAll and afterAll at the same time"
...
.method public final a()[Lcom/alibaba/sdk/android/plugin/PluginInfo;
    ...
    const-string/jumbo v2, "tae_sdk_plugins"
    ...
    const-string/jumbo v8, "tae_sdk_plugins"
    ...
    const-string/jumbo v9, "Fail to load plugin configuration properties "
