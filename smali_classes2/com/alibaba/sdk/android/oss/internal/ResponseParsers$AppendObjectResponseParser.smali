...
# virtual methods
.method public parse(Lb/ad;)Lcom/alibaba/sdk/android/oss/model/AppendObjectResult;
    .locals 2
    ...
    .line 92
    :cond_0
    const-string/jumbo v1, "x-oss-hash-crc64ecma"
...
.method public bridge synthetic parse(Lb/ad;)Ljava/lang/Object;
    ...
    .prologue
    .line 78
    invoke-virtual {p0, p1}, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers$AppendObjectResponseParser;->parse(Lb/ad;)Lcom/alibaba/sdk/android/oss/model/AppendObjectResult;
