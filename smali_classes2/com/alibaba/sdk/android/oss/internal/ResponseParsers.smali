...
.method private static parseGetBucketACLResponse(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;
    ...
    const-string/jumbo v4, "[parseGetBucketACLResponse - "
    ...
    .line 573
    :cond_5
    const-string/jumbo v6, "AccessControlList"
...
.method private static parseListPartsResponseXML(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/ListPartsResult;
    ...
    const-string/jumbo v4, "[parseObjectListResponse] - "
    ...
    .line 389
    :cond_4
    const-string/jumbo v7, "PartNumberMarker"
    ...
    .line 394
    :cond_5
    const-string/jumbo v7, "NextPartNumberMarker"
    ...
    .line 399
    :cond_6
    const-string/jumbo v7, "MaxParts"
    ...
    .line 404
    :cond_7
    const-string/jumbo v7, "IsTruncated"
    ...
    .line 417
    :cond_a
    const-string/jumbo v10, "PartNumber"
    ...
    .line 422
    :cond_b
    const-string/jumbo v10, "LastModified"
...
.method private static parseObjectListResponse(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;
    ...
    const-string/jumbo v3, "[parseObjectListResponse] - "
    ...
    .line 618
    :cond_5
    const-string/jumbo v5, "EncodingType"
    ...
    .line 637
    :cond_a
    const-string/jumbo v5, "CommonPrefixes"
...
.method public static parseObjectMetadata(Ljava/util/Map;)Lcom/alibaba/sdk/android/oss/model/ObjectMetadata;
    ...
    .line 672
    const-string/jumbo v1, "x-oss-meta-"
...
.method public static parseResponseErrorXML(Lb/ad;Z)Lcom/alibaba/sdk/android/oss/ServiceException;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v2}, Lb/ad;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lb/ae;->close()V
    :try_end_2
