...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 44
    const-string/jumbo v0, "^(?=.{1,255}$)[0-9A-Za-z](?:(?:[0-9A-Za-z]|-){0,61}[0-9A-Za-z])?(?:\\.[0-9A-Za-z](?:(?:[0-9A-Za-z]|-){0,61}[0-9A-Za-z])?)*\\.?$"
...
.method public static checkFileReadable(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "File is directory. "
...
.method public static checkFileWritable(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, " can not write. "
...
.method public static date2GMTFormat(Ljava/util/Date;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "E, dd MMM yyyy HH:mm:ss \'GMT\'"
...
.method public static validateHostName(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "The endpoint hostName is invalid! Must be like \"oss-cn-hangzhou.aliyuncs.com\" format"
