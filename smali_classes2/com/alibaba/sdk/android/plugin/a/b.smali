...
.method private static a(ZLjava/lang/String;J)V
    ...
    const-string/jumbo v1, "sdk_plugin_start_success"
    ...
    .line 337
    :cond_1
    const-string/jumbo v1, "sdk_plugin_start_failure"
...
.method public final declared-synchronized startPlugin(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "start plugin "
    ...
    const-string/jumbo v3, ".pluginStart"
    ...
    const-string/jumbo v1, "plugin not found"
    ...
    const-string/jumbo v2, "The plugin "
    ...
    const-string/jumbo v2, " was not found in the current repository"
    ...
    const-string/jumbo v5, "plugin.vendor"
    ...
    const-string/jumbo v2, "not allowed to start"
    ...
    const-string/jumbo v4, "plugin state in "
    ...
    const-string/jumbo v3, " is in the "
    ...
    const-string/jumbo v2, ", startPlugin exits"
    ...
    const-string/jumbo v5, "dependent plugin "
    ...
    const-string/jumbo v3, "The dependent plugin "
    ...
    const-string/jumbo v2, " is not started"
    ...
    const-string/jumbo v4, "Async starting the plugin "
    ...
    .line 236
    const-string/jumbo v1, "lifecycleAdapter"
    ...
    const-string/jumbo v3, "Fail to start the plugin"
...
.method public final declared-synchronized stopPlugin(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, ".pluginStop"
    ...
    const-string/jumbo v4, "The plugin "
    ...
    const-string/jumbo v4, " is in the "
    ...
    const-string/jumbo v4, " state, stopPlugin exits"
    ...
    const-string/jumbo v4, "Stopping the plugin "
    ...
    const-string/jumbo v2, "Fail to stop the plugin"
...
.method public final syncStartPlugin(Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "dependent plugin "
    ...
    const-string/jumbo v2, "The dependent plugin "
    ...
    const-string/jumbo v5, "Sync starting the plugin "
    ...
    const-string/jumbo v6, "Fail to start the plugin"
