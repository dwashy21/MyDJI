...
.field private e:Lcom/amap/api/col/da;
...
.method static a(Ljava/util/Collection;Lcom/amap/api/col/da;II)D
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-wide v8, v0, Lcom/amap/api/col/da;->a:D

    .line 460
    move-object/from16 v0, p1

    iget-wide v2, v0, Lcom/amap/api/col/da;->c:D

    .line 461
    move-object/from16 v0, p1

    iget-wide v10, v0, Lcom/amap/api/col/da;->b:D

    .line 462
    move-object/from16 v0, p1

    iget-wide v4, v0, Lcom/amap/api/col/da;->d:D
...
.method static a(Ljava/util/Collection;)Lcom/amap/api/col/da;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 373
    :cond_4
    new-instance v1, Lcom/amap/api/col/da;

    invoke-direct/range {v1 .. v9}, Lcom/amap/api/col/da;-><init>(DDDD)V
...
.method private a(I)[D
    ...
    iget-object v5, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/da;
    ...
    .line 330
    invoke-static {v1, v5, p1, v6}, Lcom/amap/api/maps/model/HeatmapTileProvider;->a(Ljava/util/Collection;Lcom/amap/api/col/da;II)D
...
.method private c(Ljava/util/Collection;)V
    ...
    invoke-static {v0}, Lcom/amap/api/maps/model/HeatmapTileProvider;->a(Ljava/util/Collection;)Lcom/amap/api/col/da;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/da;

    .line 214
    new-instance v0, Lcom/amap/api/maps/model/a;

    iget-object v1, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/da;

    invoke-direct {v0, v1}, Lcom/amap/api/maps/model/a;-><init>(Lcom/amap/api/col/da;)V
...
.method public getTile(III)Lcom/amap/api/maps/model/Tile;
    ...
    invoke-virtual {v2, v3}, Lcom/amap/api/maps/model/a;->a(Lcom/amap/api/col/da;)Ljava/util/Collection;
    ...
    .line 274
    new-instance v11, Lcom/amap/api/col/da;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/amap/api/maps/model/HeatmapTileProvider;->e:Lcom/amap/api/col/da;

    iget-wide v4, v2, Lcom/amap/api/col/da;->a:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/da;->c:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/da;->b:D
    ...
    iget-wide v4, v2, Lcom/amap/api/col/da;->d:D

    add-double v18, v18, v4

    invoke-direct/range {v11 .. v19}, Lcom/amap/api/col/da;-><init>(DDDD)V

    .line 276
    invoke-virtual {v3, v11}, Lcom/amap/api/col/da;->a(Lcom/amap/api/col/da;)Z
