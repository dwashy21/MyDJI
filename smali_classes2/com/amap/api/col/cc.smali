...
.field private h:Lcom/amap/api/mapcore/u;
...
.method public constructor <init>(Lcom/amap/api/mapcore/l;Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/amap/api/col/cc;->i:I

    .line 40
    iput-boolean v1, p0, Lcom/amap/api/col/cc;->j:Z

    .line 41
    const-string/jumbo v0, "location_map_gps_locked.png"

    iput-object v0, p0, Lcom/amap/api/col/cc;->k:Ljava/lang/String;
    ...
    .line 43
    iput-boolean v1, p0, Lcom/amap/api/col/cc;->m:Z
    ...
    iput-object v0, p0, Lcom/amap/api/col/cc;->g:Landroid/content/Context;

    .line 47
    iput-object p1, p0, Lcom/amap/api/col/cc;->a:Lcom/amap/api/mapcore/l;

    .line 48
    new-instance v0, Lcom/amap/api/mapcore/u;

    iget-object v1, p0, Lcom/amap/api/col/cc;->g:Landroid/content/Context;

    invoke-direct {v0, v1, p1}, Lcom/amap/api/mapcore/u;-><init>(Landroid/content/Context;Lcom/amap/api/mapcore/l;)V

    iput-object v0, p0, Lcom/amap/api/col/cc;->h:Lcom/amap/api/mapcore/u;
...
.method private b(F)V
    ...
    .prologue
    .line 147
    iget-object v0, p0, Lcom/amap/api/col/cc;->a:Lcom/amap/api/mapcore/l;
    ...
    invoke-static {p1}, Lcom/amap/api/col/u;->c(F)Lcom/amap/api/col/t;
...
.method private b(Landroid/location/Location;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/amap/api/col/cc;->b:Lcom/amap/api/maps/model/Marker;
...
.method private c(F)V
    ...
    invoke-static {p1}, Lcom/amap/api/col/u;->d(F)Lcom/amap/api/col/t;
...
.method private f()V
    ...
    .line 105
    iget-object v0, p0, Lcom/amap/api/col/cc;->b:Lcom/amap/api/maps/model/Marker;

    if-eqz v0, :cond_1

    .line 106
    invoke-direct {p0, v2}, Lcom/amap/api/col/cc;->c(F)V

    .line 107
    iget-object v0, p0, Lcom/amap/api/col/cc;->h:Lcom/amap/api/mapcore/u;
    ...
    .line 112
    invoke-direct {p0, v2}, Lcom/amap/api/col/cc;->b(F)V
...
.method private h()V
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/u;->a()V
    ...
    invoke-static {v1}, Lcom/amap/api/col/u;->a(F)Lcom/amap/api/col/t;
    ...
    invoke-direct {p0, v0}, Lcom/amap/api/col/cc;->b(F)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private i()V
    ...
    iget-boolean v0, p0, Lcom/amap/api/col/cc;->j:Z
    ...
    .line 222
    iget-object v1, p0, Lcom/amap/api/col/cc;->e:Lcom/amap/api/maps/model/LatLng;
    ...
    .line 223
    iget-object v1, p0, Lcom/amap/api/col/cc;->a:Lcom/amap/api/mapcore/l;

    invoke-static {v0}, Lcom/amap/api/col/u;->a(Lcom/autonavi/amap/mapcore/IPoint;)Lcom/amap/api/col/t;
...
.method private j()V
    ...
    .prologue
    .line 231
    iget-object v0, p0, Lcom/amap/api/col/cc;->d:Lcom/amap/api/maps/model/MyLocationStyle;
    ...
    iput-object v0, p0, Lcom/amap/api/col/cc;->d:Lcom/amap/api/maps/model/MyLocationStyle;
    ...
    .line 234
    invoke-direct {p0}, Lcom/amap/api/col/cc;->l()V
    ...
    iput-boolean v0, p0, Lcom/amap/api/col/cc;->m:Z
...
.method private k()V
    ...
    .line 250
    iget-object v0, p0, Lcom/amap/api/col/cc;->c:Lcom/amap/api/maps/model/Circle;
    ...
    iget-object v1, p0, Lcom/amap/api/col/cc;->c:Lcom/amap/api/maps/model/Circle;
    ...
    .line 257
    :goto_0
    iput-object v3, p0, Lcom/amap/api/col/cc;->c:Lcom/amap/api/maps/model/Circle;
    ...
    .line 263
    iput-object v3, p0, Lcom/amap/api/col/cc;->b:Lcom/amap/api/maps/model/Marker;

    .line 264
    iget-object v0, p0, Lcom/amap/api/col/cc;->h:Lcom/amap/api/mapcore/u;

    invoke-virtual {v0, v3}, Lcom/amap/api/mapcore/u;->a(Lcom/amap/api/maps/model/Marker;)V
...
.method private l()V
    ...
    iget-object v2, p0, Lcom/amap/api/col/cc;->d:Lcom/amap/api/maps/model/MyLocationStyle;
    ...
    .line 284
    invoke-interface {v0, v1}, Lcom/amap/api/mapcore/l;->addCircle(Lcom/amap/api/maps/model/CircleOptions;)Lcom/amap/api/maps/model/Circle;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/col/cc;->c:Lcom/amap/api/maps/model/Circle;

    .line 289
    iget-object v0, p0, Lcom/amap/api/col/cc;->e:Lcom/amap/api/maps/model/LatLng;
    ...
    iget-wide v2, p0, Lcom/amap/api/col/cc;->f:D
    ...
    iget-object v3, p0, Lcom/amap/api/col/cc;->d:Lcom/amap/api/maps/model/MyLocationStyle;
    ...
    .line 293
    invoke-interface {v0, v1}, Lcom/amap/api/mapcore/l;->addMarker(Lcom/amap/api/maps/model/MarkerOptions;)Lcom/amap/api/maps/model/Marker;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/col/cc;->b:Lcom/amap/api/maps/model/Marker;

    .line 297
    iget v0, p0, Lcom/amap/api/col/cc;->i:I

    invoke-virtual {p0, v0}, Lcom/amap/api/col/cc;->a(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/amap/api/mapcore/u;->a(Lcom/amap/api/maps/model/Marker;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(I)V
    ...
    .prologue
    .line 71
    iput p1, p0, Lcom/amap/api/col/cc;->i:I

    .line 72
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/amap/api/col/cc;->j:Z
    ...
    .line 75
    :pswitch_0
    invoke-direct {p0}, Lcom/amap/api/col/cc;->f()V

    goto :goto_0

    .line 79
    :pswitch_1
    invoke-direct {p0}, Lcom/amap/api/col/cc;->g()V

    goto :goto_0

    .line 83
    :pswitch_2
    invoke-direct {p0}, Lcom/amap/api/col/cc;->h()V
...
.method public a(Landroid/location/Location;)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/cc;->e:Lcom/amap/api/maps/model/LatLng;
    ...
    iput-wide v0, p0, Lcom/amap/api/col/cc;->f:D
    ...
    .line 178
    invoke-direct {p0}, Lcom/amap/api/col/cc;->j()V
    ...
    .line 186
    iget-wide v0, p0, Lcom/amap/api/col/cc;->f:D
    ...
    :cond_4
    :goto_1
    invoke-direct {p0}, Lcom/amap/api/col/cc;->i()V
    ...
    .line 195
    invoke-direct {p0, p1}, Lcom/amap/api/col/cc;->b(Landroid/location/Location;)V
...
.method public a(Lcom/amap/api/maps/model/MyLocationStyle;)V
    ...
    .line 53
    :try_start_0
    iput-object p1, p0, Lcom/amap/api/col/cc;->d:Lcom/amap/api/maps/model/MyLocationStyle;
    ...
    .line 57
    :cond_0
    invoke-direct {p0}, Lcom/amap/api/col/cc;->k()V
