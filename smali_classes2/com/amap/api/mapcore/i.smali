...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amap/api/mapcore/i$b;,
        Lcom/amap/api/mapcore/i$c;,
...
.field private b:Lcom/amap/api/mapcore/b;
...
.method public constructor <init>(Lcom/amap/api/mapcore/b;Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/amap/api/mapcore/i;->a:Z

    .line 70
    iput-object v1, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    .line 71
    iput-object v1, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;

    .line 72
    iput-object v1, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;

    .line 103
    iput-object p1, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    .line 104
    iput-object p2, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;

    .line 105
    iget-object v0, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    invoke-virtual {v0}, Lcom/amap/api/mapcore/b;->a()Lcom/autonavi/amap/mapcore/MapCore;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;

    .line 106
    return-void
.end method

.method static synthetic a(Lcom/amap/api/mapcore/i;)Lcom/autonavi/amap/mapcore/MapCore;
    .locals 1

    .prologue
    .line 17
    iget-object v0, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;
...
.method static synthetic a(Lcom/amap/api/mapcore/i;[B[B[B[B[B)V
    .locals 0

    .prologue
    .line 17
    invoke-direct/range {p0 .. p5}, Lcom/amap/api/mapcore/i;->a([B[B[B[B[B)V
...
.method public a()V
    ...
    .line 114
    invoke-virtual {p0}, Lcom/amap/api/mapcore/i;->b()Ljava/lang/String;

    move-result-object v1

    .line 116
    iget-object v2, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;
    ...
    .line 119
    iget-object v2, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    invoke-virtual {v2}, Lcom/amap/api/mapcore/b;->getMapConfig()Lcom/autonavi/amap/mapcore/MapConfig;
    ...
    invoke-direct {v1, v2}, Lcom/amap/api/col/cv;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v2}, Lcom/amap/api/col/cv;->b(Ljava/lang/String;)[B
    ...
    .line 124
    invoke-virtual {p0, v1}, Lcom/amap/api/mapcore/i;->a([B)V

    .line 132
    :cond_2
    :goto_1
    iget-object v1, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;
    ...
    .line 135
    iget-object v1, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;
    ...
    .line 128
    iget-object v2, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;
...
.method public a(Z)V
    ...
    .line 157
    invoke-virtual {p0}, Lcom/amap/api/mapcore/i;->c()Ljava/lang/String;

    move-result-object v2

    .line 158
    invoke-direct {p0, v2}, Lcom/amap/api/mapcore/i;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 159
    iget-object v4, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;
    ...
    .line 161
    iget-boolean v4, p0, Lcom/amap/api/mapcore/i;->a:Z
    ...
    .line 169
    :cond_2
    iget-object v3, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;
    ...
    .line 173
    iget-object v3, p0, Lcom/amap/api/mapcore/i;->d:Lcom/autonavi/amap/mapcore/MapCore;
    ...
    .line 178
    :cond_4
    iget-boolean v1, p0, Lcom/amap/api/mapcore/i;->a:Z
    ...
    .line 183
    :cond_5
    iget-object v3, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    new-instance v4, Lcom/amap/api/mapcore/i$1;

    invoke-direct {v4, p0, v2, v1, v0}, Lcom/amap/api/mapcore/i$1;-><init>(Lcom/amap/api/mapcore/i;[B[B[B)V
...
.method public b()Ljava/lang/String;
    ...
    .line 213
    iget-object v1, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;
    ...
    invoke-virtual {v1}, Lcom/amap/api/mapcore/b;->v()Lcom/amap/api/mapcore/i$c;
    ...
    invoke-virtual {v2}, Lcom/amap/api/mapcore/b;->w()Lcom/amap/api/mapcore/i$a;
    ...
    invoke-virtual {v3}, Lcom/amap/api/mapcore/b;->x()Lcom/amap/api/mapcore/i$b;

    move-result-object v3

    .line 220
    sget-object v4, Lcom/amap/api/mapcore/i$c;->a:Lcom/amap/api/mapcore/i$c;
    ...
    .line 222
    sget-object v0, Lcom/amap/api/mapcore/i$b;->e:Lcom/amap/api/mapcore/i$b;
    ...
    .line 224
    :cond_2
    sget-object v0, Lcom/amap/api/mapcore/i$b;->c:Lcom/amap/api/mapcore/i$b;
    ...
    .line 226
    :cond_3
    sget-object v0, Lcom/amap/api/mapcore/i$b;->b:Lcom/amap/api/mapcore/i$b;
    ...
    .line 228
    :cond_4
    sget-object v0, Lcom/amap/api/mapcore/i$b;->f:Lcom/amap/api/mapcore/i$b;
    ...
    .line 250
    :cond_c
    sget-object v4, Lcom/amap/api/mapcore/i$c;->b:Lcom/amap/api/mapcore/i$c;
...
.method public b(Z)V
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/b;->v()Lcom/amap/api/mapcore/i$c;
    ...
    .line 304
    iget-object v0, p0, Lcom/amap/api/mapcore/i;->c:Landroid/content/Context;
    ...
    .line 335
    invoke-direct/range {v0 .. v5}, Lcom/amap/api/mapcore/i;->a([B[B[B[B[B)V
    ...
    new-instance v6, Lcom/amap/api/mapcore/i$2;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/amap/api/mapcore/i$2;-><init>(Lcom/amap/api/mapcore/i;[B[B[B[B[B)V
...
.method public c()Ljava/lang/String;
    ...
    .line 287
    sget-object v3, Lcom/amap/api/mapcore/i$c;->a:Lcom/amap/api/mapcore/i$c;

    if-ne v3, v1, :cond_3

    .line 288
    sget-object v0, Lcom/amap/api/mapcore/i$a;->c:Lcom/amap/api/mapcore/i$a;
    ...
    .line 292
    :cond_3
    sget-object v3, Lcom/amap/api/mapcore/i$c;->b:Lcom/amap/api/mapcore/i$c;
...
.method public c(Z)V
    ...
    new-instance v3, Lcom/amap/api/mapcore/i$3;

    invoke-direct {v3, p0, v1, v0}, Lcom/amap/api/mapcore/i$3;-><init>(Lcom/amap/api/mapcore/i;[B[B)V
...
.method public e(Z)V
    ...
    .line 494
    :cond_0
    iget-object v7, p0, Lcom/amap/api/mapcore/i;->b:Lcom/amap/api/mapcore/b;

    new-instance v0, Lcom/amap/api/mapcore/i$4;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Lcom/amap/api/mapcore/i$4;-><init>(Lcom/amap/api/mapcore/i;[B[B[B[B[B)V
