...
# interfaces
.implements Lcom/amap/api/col/y$a;
...
# virtual methods
.method public a(Lcom/amap/api/col/y;)Z
    .locals 9
    ...
    iget-object v2, v2, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/l;

    invoke-interface {v2}, Lcom/amap/api/mapcore/l;->m()Lcom/amap/api/mapcore/o;

    move-result-object v2

    invoke-interface {v2}, Lcom/amap/api/mapcore/o;->isTiltGesturesEnabled()Z
    ...
    invoke-static {v2}, Lcom/amap/api/mapcore/h;->c(Lcom/amap/api/mapcore/h;)I
    ...
    .line 690
    :cond_2
    invoke-virtual {p1}, Lcom/amap/api/col/y;->c()Landroid/graphics/PointF;
    ...
    invoke-static {v4}, Lcom/amap/api/mapcore/h;->i(Lcom/amap/api/mapcore/h;)Z
    ...
    invoke-virtual {p1, v4}, Lcom/amap/api/col/y;->a(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {p1, v5}, Lcom/amap/api/col/y;->a(I)Landroid/graphics/PointF;
    ...
    invoke-static {v1, v2}, Lcom/amap/api/mapcore/h;->b(Lcom/amap/api/mapcore/h;Z)Z
    ...
    new-instance v3, Lcom/amap/api/col/ag;

    const/16 v4, 0x65

    invoke-direct {v3, v4, v1}, Lcom/amap/api/col/ag;-><init>(IF)V
...
.method public b(Lcom/amap/api/col/y;)Z
    .locals 5
    ...
    invoke-interface {v0}, Lcom/amap/api/mapcore/o;->isTiltGesturesEnabled()Z
    ...
    .line 742
    invoke-interface {v3}, Lcom/amap/api/mapcore/l;->getCameraAngle()F

    move-result v3

    invoke-direct {v1, v2, v3}, Lcom/amap/api/col/ag;-><init>(IF)V
...
.method public c(Lcom/amap/api/col/y;)V
    .locals 4
