...
.method private a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "> SERVER_SHORT_LINK_URL content after replace link ===  %s"
...
.method public a(Ljava/lang/String;IZLjava/lang/String;)Ljava/lang/String;
    ...
    .line 417
    const-string/jumbo v0, "<a[^>]*?href[\\s]*=[\\s]*[\"\']?([^\'\">]+?)[\'\"]?>"
    ...
    .line 424
    :cond_2
    const-string/jumbo v0, "(http://|https://){1}[\\w\\.\\-/:\\?&%=,;\\[\\]\\{\\}`~!@#\\$\\^\\*\\(\\)_\\+\\\\\\|]+"
...
.method public b()V
    ...
    const-string/jumbo v4, "service_time"
    ...
    .line 126
    const-string/jumbo v5, "backflow"
    ...
    .line 136
    :cond_4
    const-string/jumbo v0, "serpaths"
