...
.field private I:Ldji/midware/g/a/b;
...
.field private d:Ldji/logic/album/manager/b/h;
...
.method public constructor <init>()V
    ...
    .line 19
    iput-boolean v1, p0, Ldji/midware/media/i/j;->F:Z

    .line 257
    iput-boolean v1, p0, Ldji/midware/media/i/j;->a:Z

    .line 258
    iput-boolean v1, p0, Ldji/midware/media/i/j;->b:Z
    ...
    iput-object v0, p0, Ldji/midware/media/i/j;->v:[B

    .line 27
    iget-object v0, p0, Ldji/midware/media/i/j;->v:[B
    ...
    iput v0, p0, Ldji/midware/media/i/j;->G:F
    ...
    iput-object v0, p0, Ldji/midware/media/i/j;->d:Ldji/logic/album/manager/b/h;
...
.method static synthetic a(Ldji/midware/media/i/j;J)J
    ...
    .prologue
    .line 16
    iput-wide p1, p0, Ldji/midware/media/i/j;->H:J

    return-wide p1
.end method

.method static synthetic a(Ldji/midware/media/i/j;)Ldji/logic/album/manager/b/h;
    .locals 1

    .prologue
    .line 16
    iget-object v0, p0, Ldji/midware/media/i/j;->d:Ldji/logic/album/manager/b/h;
...
.method public a()V
    ...
    .line 36
    iput-object v1, p0, Ldji/midware/media/i/j;->v:[B
    ...
    .line 39
    iput-object v1, p0, Ldji/midware/media/i/j;->d:Ldji/logic/album/manager/b/h;
...
.method protected a(I)V
    ...
    .line 122
    :cond_0
    iput-boolean v10, p0, Ldji/midware/media/i/j;->F:Z
    ...
    iget v2, p0, Ldji/midware/media/i/j;->j:I
    ...
    const-string/jumbo v5, "seekToOffset="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-wide v6, p0, Ldji/midware/media/i/j;->m:J
    ...
    iget-wide v6, p0, Ldji/midware/media/i/j;->H:J
    ...
    .line 127
    iget-object v2, p0, Ldji/midware/media/i/j;->i:Ldji/logic/album/model/DJIAlbumFileInfo;
    ...
    invoke-virtual {v0}, Ldji/logic/album/manager/b/h;->j()Z
    ...
    .line 129
    iget-object v0, p0, Ldji/midware/media/i/j;->i:Ldji/logic/album/model/DJIAlbumFileInfo;

    iget-wide v4, v0, Ldji/logic/album/model/DJIAlbumFileInfo;->a:J

    iput-wide v4, p0, Ldji/midware/media/i/j;->H:J
    ...
    iput-wide v4, p0, Ldji/midware/media/i/j;->o:J

    .line 132
    :cond_1
    iget-boolean v0, p0, Ldji/midware/media/i/j;->s:Z

    if-nez v0, :cond_2

    iget v0, p0, Ldji/midware/media/i/j;->l:I

    if-ge p1, v0, :cond_5

    iget-wide v4, p0, Ldji/midware/media/i/j;->H:J
    ...
    const-string/jumbo v6, "local file seekTo="
    ...
    const-string/jumbo v6, " fileInfo.length="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Ldji/midware/media/i/j;->i:Ldji/logic/album/model/DJIAlbumFileInfo;
    ...
    iput-wide v2, p0, Ldji/midware/media/i/j;->n:J

    .line 139
    :try_start_0
    iget-object v0, p0, Ldji/midware/media/i/j;->t:Ljava/io/RandomAccessFile;

    iget-wide v2, p0, Ldji/midware/media/i/j;->n:J
    ...
    .line 147
    iget-object v0, p0, Ldji/midware/media/i/j;->E:Ldji/midware/media/i/d$f;
    ...
    .line 182
    :cond_4
    iput-boolean v11, p0, Ldji/midware/media/i/j;->F:Z
    ...
    const-string/jumbo v4, "remote file seekTo "
    ...
    .line 153
    iput-wide v12, p0, Ldji/midware/media/i/j;->o:J
    ...
    invoke-virtual {v0, v4}, Ldji/logic/album/manager/b/h;->a(Ldji/midware/data/model/d/g$a;)V
    ...
    const-string/jumbo v6, "remote file isCached "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Ldji/midware/media/i/j;->d:Ldji/logic/album/manager/b/h;

    invoke-virtual {v6}, Ldji/logic/album/manager/b/h;->j()Z
    ...
    iput-object v0, p0, Ldji/midware/media/i/j;->t:Ljava/io/RandomAccessFile;
    :try_end_2
...
.method protected a(JJJ)V
    ...
    iput v0, p0, Ldji/midware/media/i/j;->l:I

    .line 227
    iget v0, p0, Ldji/midware/media/i/j;->l:I

    iget v3, p0, Ldji/midware/media/i/j;->k:I
    ...
    iget v3, p0, Ldji/midware/media/i/j;->G:F
    ...
    iput-boolean v0, p0, Ldji/midware/media/i/j;->r:Z
    ...
    const-string/jumbo v5, "cachedPos="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Ldji/midware/media/i/j;->l:I
    ...
    iget v5, p0, Ldji/midware/media/i/j;->G:F
    ...
    iget-object v0, p0, Ldji/midware/media/i/j;->C:Ldji/midware/media/i/d$a;
    ...
    iget v0, p0, Ldji/midware/media/i/j;->G:F

    iget v4, p0, Ldji/midware/media/i/j;->j:I
    ...
    .line 246
    :cond_5
    iget-object v1, p0, Ldji/midware/media/i/j;->C:Ldji/midware/media/i/d$a;
    ...
    iget v1, p0, Ldji/midware/media/i/j;->k:I

    sub-int/2addr v0, v1

    int-to-float v0, v0

    iget v1, p0, Ldji/midware/media/i/j;->G:F
    ...
    .line 251
    :cond_7
    iput-boolean v6, p0, Ldji/midware/media/i/j;->r:Z
...
.method public a(Ldji/logic/album/model/DJIAlbumFileInfo;)V
    ...
    iput v0, p0, Ldji/midware/media/i/j;->j:I

    .line 46
    iget-object v0, p0, Ldji/midware/media/i/j;->d:Ldji/logic/album/manager/b/h;

    iget-object v1, p0, Ldji/midware/media/i/j;->z:Ldji/logic/album/manager/c$a;
...
.method protected a([BI)V
    ...
    .line 269
    invoke-static {p1, v1}, Ldji/midware/i/c;->g([BI)J
    ...
    iget-object v4, p0, Ldji/midware/media/i/j;->f:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "preMagic="
    ...
    const-string/jumbo v3, " isMixStream="
    ...
    .line 275
    iget-object v0, p0, Ldji/midware/media/i/j;->I:Ldji/midware/g/a/b;
    ...
    iput-object v0, p0, Ldji/midware/media/i/j;->I:Ldji/midware/g/a/b;
...
.method protected declared-synchronized g()V
    ...
    :try_start_0
    iget-boolean v0, p0, Ldji/midware/media/i/j;->F:Z
