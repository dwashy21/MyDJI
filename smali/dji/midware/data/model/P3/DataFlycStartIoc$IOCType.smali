...
.field public static final enum Cinematic:Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "IOCTypeCourseLock"

    invoke-direct {v0, v1, v8, v5}, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;-><init>(Ljava/lang/String;II)V
    ...
    const-string/jumbo v1, "IOCTypeHomeLock"
    ...
    const-string/jumbo v1, "IOCTripod"

    invoke-direct {v0, v1, v6, v7}, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;-><init>(Ljava/lang/String;II)V
    ...
    const-string/jumbo v1, "IOCTypeHomeLockA2"

    invoke-direct {v0, v1, v7, v4}, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v1, v4, v4}, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;->Cinematic:Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;

    .line 96
    new-instance v0, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;

    const-string/jumbo v1, "IOCTypeOther"

    const/4 v2, 0x5

    const/16 v3, 0x64

    invoke-direct {v0, v1, v2, v3}, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;-><init>(Ljava/lang/String;II)V
    ...
    sget-object v2, Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;->IOCTypeOther:Ldji/midware/data/model/P3/DataFlycStartIoc$IOCType;
